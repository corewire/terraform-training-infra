...
#gitlab_rails['gitlab_email_from'] = 'git@derdurner.de'
#gitlab_rails['gitlab_email_display_name'] = 'git - derdurner.de'
#gitlab_rails['gitlab_email_reply_to'] = 'noreply@derdurner.de'
...
####! The email address including the `` placeholder that will be replaced
...
# gitlab_rails['incoming_email_address'] = "gitlab-incoming+@gmail.com"
...
#  {
#    "name" => "oauth2_generic",
#    "app_id" => "git.derdurner.de",
#    "app_secret" => "ac409400-31fc-4eb1-b8e3-f688549ebe71",
#    "args" => { 
#      "client_options" => {
#        "site" => "https://auth.derdurner.de",
...
gitlab_rails['gitlab_shell_ssh_port'] = 9110
...
#gitlab_rails['smtp_address'] = "mail.prismadruck.com"
#gitlab_rails['smtp_port'] = 465
#gitlab_rails['smtp_user_name'] = "web@derdurner.de"
#gitlab_rails['smtp_password'] = "pass"
#gitlab_rails['smtp_domain'] = "derdurner.de"
...
# registry_external_url 'https://registry.git.derdurner.de'

### Settings used by GitLab application
#gitlab_rails['registry_enabled'] = true
#gitlab_rails['registry_host'] = "registry.git.derdurner.de"
...
# nginx['redirect_http_to_https_port'] = 9112
